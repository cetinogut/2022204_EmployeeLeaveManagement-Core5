...
using EmployeeLeaveManagement.Common.SessionOperations;
using Microsoft.AspNetCore.Http;
using Newtonsoft.Json;
using EmployeeLeaveManagement.Data.DbModels;

namespace _2022204_EmployeeLeaveManagement_Core5.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //var user = _unitOfWork.employeeRepository.GetFirstOrDefault( u => u.Email == Input.Email );
                    if (user != null)
                    {
